...
final class Auth
{
    ...
    public static function user(): ?array
    {
        ...
        return Db::one('SELECT id, kind, name, email, phone, district, avatar_url, google_sub, email_verified_at, created_at FROM users WHERE id = ? AND deleted_at IS NULL', [(int) $claims['sub']]);
    }
