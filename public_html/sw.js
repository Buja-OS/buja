...
const VERSION = 'buja-shell-v34';
const SHELL = [
  '/', '/index.html', '/manifest.webmanifest', '/assets/icons/icon-192.png', '/assets/icons/icon-512.png', '/offline.html',
  '/css/app.css', '/js/app.js', '/js/api.js', '/js/ui.js', '/js/store.js', '/js/icons.js', '/js/work.js', '/js/messages.js', '/js/match.js', '/js/waka.js', '/js/homes.js', '/js/declutter.js', '/js/ask.js', '/js/trust.js', '/js/city.js', '/js/safety.js', '/js/growth.js', '/js/call.js', '/js/rtc.js', '/js/alerts.js', '/js/trustalerts.js', '/js/services.js', '/js/passkey.js',
