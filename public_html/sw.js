...
const VERSION = 'buja-shell-v8';
const SHELL = [
  '/', '/index.html', '/manifest.webmanifest', '/offline.html',
  '/css/app.css', '/js/app.js', '/js/api.js', '/js/ui.js', '/js/store.js', '/js/icons.js', '/js/work.js', '/js/messages.js', '/js/match.js', '/js/waka.js', '/js/homes.js', '/js/declutter.js',
