      ...
      const send = async (q) => {
        ...
        try {
          ...
          think.innerHTML = `${bot}<div class="grow stack" style="gap:10px;min-width:0">
            ...
            <div class="small muted row" style="gap:6px;align-items:flex-start;line-height:1.45">${icon('circle-info')} <span>Places come from OpenStreetMap and Buja residents. Hours and "open now" are only shown when the place lists them. See something wrong? Open the place and tell us.</span></div>
