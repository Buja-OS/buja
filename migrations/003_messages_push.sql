...
ALTER TABLE users ADD COLUMN notify_work   TINYINT(1) NOT NULL DEFAULT 1;
ALTER TABLE users ADD COLUMN notify_match  TINYINT(1) NOT NULL DEFAULT 1;
ALTER TABLE users ADD COLUMN notify_waka   TINYINT(1) NOT NULL DEFAULT 1;
ALTER TABLE users ADD COLUMN notify_offers TINYINT(1) NOT NULL DEFAULT 0;
